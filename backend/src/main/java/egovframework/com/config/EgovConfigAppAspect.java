...
public class EgovConfigAppAspect {
	...
	@Bean
	public DefaultExceptionHandleManager defaultExceptionHandleManager(@Qualifier("egovHandler") ExceptionHandler egovHandler, 
																	AntPathMatcher antPathMatcher) {
		DefaultExceptionHandleManager defaultExceptionHandleManager = new DefaultExceptionHandleManager();
		defaultExceptionHandleManager.setReqExpMatcher(antPathMatcher);
		defaultExceptionHandleManager.setPatterns(new String[] {"**service.impl.*, **service.*"});
